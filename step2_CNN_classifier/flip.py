...
def get_data(train_or_test):
    ...
    if isTrain:
        ...
        augmentors = [
            ...
            imgaug.Flip(horiz=True, prob=1.1),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inputlist', help='')
    ...
    # if args.eval:
    BATCH_SIZE = 256    # something that can run on one gpu
    eval_on_ILSVRC12(args.load, args.data, args.out, args.inputlist)
    sys.exit()
